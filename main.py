    ...
    <div class="container">
        ...
        <main class="row">
            ...
            <div class="row text-center">
                <div class="col-12">
                    <div class="card">
                        <h3 class="my-0 fw-normal mt-3">FAQ</h3>
                        <div class="card-body">
                            <p class="d-inline-flex gap-1">
                                <a class="btn btn-primary" style="width: 300px" data-bs-toggle="collapse"
                                   href="#multiCollapseExample1"
                                   role="button" aria-expanded="false" aria-controls="multiCollapseExample1">Как
                                    Купить?</a>
                                <button class="btn btn-primary" style="width: 300px" type="button"
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample1">
                                        <div class="card card-body">
                                            Нажмите кнопку купить в карточке товара и следуйте дальнейшим подсказкам
                                            сайта.
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample2">
                                        <div class="card card-body">
                                            После того как вы оформите корзину, вам будет предложено заполнить форму
                                            доставки товара. Заполните адрес, дату и время доставки.
                                        </div>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="collapse multi-collapse" id="multiCollapseExample3">
                                        <div class="card card-body">
                                            Весь товар приобретаемый на нашем сайте имеет гарантию производителя и
                                            стандартную гарантию магазина - 1 год.
                                        </div>
                                    </div>
                                </div>
                            </div>
